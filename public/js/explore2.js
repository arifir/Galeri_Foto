...
function loadMoreData(paginate) {
    ...
    if (cariValue == 'null') {
        url = '/getDataExplore2' + '?page=' + paginate;
    } else {
        url = '/getDataExplore2?cari=' + cariValue + '&page=' + paginate
    }
    $.ajax({
        // url: '/getDataExplore2' + '?page=' + paginate,
        url: url,
        ...
        $('#exploreData').append(
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="product__item">
                    <a href="/foto-detail/ ${x.id}">
                    <div class="product__item__pic set-bg" data-setbg="">

                    <img src="/foto/${x.url}" class="product__item__pic set-bg">
                    <div class="comment"><i class="fa fa-heart"></i> ${x.likephoto_count}</div>
                    <div class="view"><i class="fa fa-comments"></i> ${x.comment_count}</div>
                        ...
                        <div class="product__item__text">
                            ...
                            <h5 class="text-white"><a href="/foto-detail/{{ $isi->id }}"></a>${x.judul_photo}</h5>
                        </div>
                    </a>
                </div >
            </div >
            ...
            // <div class="col-lg-4 col-md-6 col-sm-6">
            //     <div class="product__item">
            //         <a href="/foto-detail/ ${x.id }"><div class="product__item__pic set-bg" data-setbg="">
            //             <img src="/foto/${x.url}" class="product__item__pic set-bg">
            ...
            //                     <li>${x.categories.name}</li>
            //                 </ul>
            //                 <h5><a href="/foto-detail/{{ $isi->id }}"></a>${x.judul_photo}</h5>
            //             </div>
            //         </a>
            //     </div >
            // </div >
