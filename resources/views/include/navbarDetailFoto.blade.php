    ...
    <header class="header">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    <div class="header__logo imgLogo">
                        <a href="#">
                                {{-- <img src="asset('img/logo-2.png')" alt="" > --}}
                                {{-- <i onclick="kembaliDariRiwayat()" class="arrow_left"></i> --}}
                                <a href="/home">
                ...
                <div class="col-lg-8">
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                {{-- <li class="text-white"><a onclick="kembaliDariRiwayat()">Homepage</a></li> --}}
                                ...
                                {{-- <li><a href="/archive" class=""><i class="icon_tags"></i> Favorite</a></li> --}}
                                {{-- <li><a href="/add-foto" class=""><i class="icon_upload"></i> Upload</a></li> --}}
                                {{-- <a href="add-foto.html" class="btn btn-secondary">ADD</a> --}}
                            </ul>
                        </nav>
                    </div>
                </div>
